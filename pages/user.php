              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form action="../action/action_daftarulang.php" method="post" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="nisn" value="<?php echo $row['nisn'];?>" placeholder="Masukan NISN Contoh : 0005123123"  required="required" class="form-control col-md-7 col-xs-12" >
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="nama" value="<?php echo $row['nama'];?>" placeholder="Masukan Nama Lengkap Contoh: Asep Doni Pradana" class="form-control col-md-7 col-xs-12" required>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="asal_sekolah" value="<?php echo $row['asal_sekolah'];?>"  class="form-control col-md-7 col-xs-12" placeholder="Masukan Asal Sekolah Contoh : SMPN 1 Bandung" required>
                        </div>
                      </div>
                      ...
                      <input type="hidden" name="pernyataan" value="<?php echo $row['pernyataan'];?>"  class="form-control col-md-7 col-xs-12" disabled>
                      <?php
                        include "../config/koneksi.php";
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="checkbox" name="pernyataan" required=""> Dengan ini Saya <?php echo $row['nama'];?> Menyatakan melakukan Daftar Ulang untuk menjadi siswa SMKN 1 Talaga sesuai Hasil Seleksi PPDB tahun 2021
                        </div>
                      </div>
                      ...
                      ?> 
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pernyataan">Pernyataan<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
