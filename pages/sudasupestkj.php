              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <a href="downloadtkj.php" target="_blank" class="btn btn-success">Download Data TKJ</a>
                     <table id="datatable" class="table table-striped table-bordered dt-responsive" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <?php
                          ...
                          error_reporting(0);
                          $sql=mysqli_query($conn, "SELECT * FROM t_user LEFT JOIN t_periodik ON t_user.id_user = t_periodik.id_user WHERE t_user.level=0 AND t_periodik.jurusan='TKJ' order by t_user.hasil_seleksi asc");
